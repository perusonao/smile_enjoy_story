// Screen capture for SES HOME Final Touch: serves build/web on a local
// port and screenshots the fresh-April HOME at the two required mobile
// viewports. Throwaway script for this task's visual-acceptance evidence,
// mirrors e2e/scripts/ses-home-final-visual-match-screenshot.mjs's own
...
const LABEL = process.argv[4] || 'AFTER'; // e.g. BEFORE / AFTER
const PORT = 8938;
...
for (const size of sizes) {
  ...
  const homeOut = `${OUT_DIR}/SES_HOME-VISUAL-SSOT-EXACT_${LABEL}_${size.name}.png`;
