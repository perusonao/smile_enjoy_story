...
4. **Employee lifecycle status clarity** — P1, estimated 2–3h. Make waiting → sales-ready/in-sales → interview → ordered → next-month assignment → assigned understandable and consistent across surfaces.
