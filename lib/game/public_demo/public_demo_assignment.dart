...
class PublicDemoAssignment {
  ...
  final String engineerId,engineerName,projectName; final int deliveryPressure,budgetHealth,skill,humanity; final PublicDemoNextOrderStatus nextOrderStatus; final PublicDemoReplacementStage replacementStage;
  ...
  PublicDemoAssignment copyWith({PublicDemoNextOrderStatus? nextOrderStatus,PublicDemoReplacementStage? replacementStage})=>PublicDemoAssignment(engineerId:engineerId,engineerName:engineerName,projectName:projectName,deliveryPressure:deliveryPressure,budgetHealth:budgetHealth,skill:skill,humanity:humanity,nextOrderStatus:nextOrderStatus??this.nextOrderStatus,replacementStage:replacementStage??this.replacementStage);
}
