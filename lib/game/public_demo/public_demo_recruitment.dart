...
/// CORE-GAMEPLAY Phase 4.5: **legacy-only**, kept solely so a save created
/// before this fix (which persisted these two applicants, hand-authored, as
/// [PublicDemoWorkflowState.initial]'s pre-seeded founding pool) still loads
/// and behaves exactly as it always did. [PublicDemoWorkflowState.initial]
/// no longer reads this constant — a new game now starts with zero
/// applicants; every applicant from that point on is generated by
/// [PublicDemoAggregate.recruit] via [PublicDemoSeededRecruitmentGenerator].
/// [PublicDemoRecruitmentInterview]'s id-only fallback (these two ids were
/// never producible by that generator) also still reads this constant, for
/// the same already-existing-save reason. Not used to seed anything new.
