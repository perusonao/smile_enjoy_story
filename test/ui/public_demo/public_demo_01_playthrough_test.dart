...
void main() {
  testWidgets('Public Demo can be operated from April through July', (
    ...
    // Issue #168 Finding C: the two applicants this dialog introduces are
    // pre-seeded from game start, not generated by any April action the
    // player did or didn't take — the former copy falsely implied a
    // just-happened recruiting event.
    ...
    // recruitment media was never used — both genuine outstanding
    // candidates. Proceed anyway, same reasoning as April above.
    await dismissMonthGuardIfPresent(tester);
